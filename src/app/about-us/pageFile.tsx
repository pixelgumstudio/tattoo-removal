    ...
    <>
      ...
      <Section>
        <Paragraph className={clsx("leading-relaxed mb-4")}>
          ...
          youc an remove tattoos in the US./ We list all the cities and states
          you can get your tattoo removed in the US 
        </Paragraph>
        <Paragraph className={clsx("leading-relaxed mb-4")}>
          We started tattooremovalnearyou after doing a whole background
          research about how to remove tattoos and we  could not find places
          listed on the google search on how a tattoo needs to be =removed and
          how tos 
        </Paragraph>
        <Paragraph className={clsx("leading-relaxed mb-4")}>
          In the United States, there are over a thousand tattoo removal
          places, with many options to choose from if you’re based in more
          populated cities.
        </Paragraph>
